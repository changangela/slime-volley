function Fence(fenceX, fenceY, fenceWidth, fenceHeight, fenceColor) {
    ...
    this.show = function() {
    	fill(this.color);
    	stroke(this.color);
    	arc(this.position.x + this.tipRadius, this.position.y + this.tipRadius, this.tipRadius * 2, this.tipRadius * 2, PI, PI * 2);
        rect(this.position.x, this.position.y + this.tipRadius, this.size.x, this.size.y - this.tipRadius);
    }
}